...
def main():
	# 修改为正确的绝对路径
	data_file = 'E:/stock/baseline_repo/data/train.csv'
	
	# v2 模型路径
	model_path = 'E:/stock/baseline_repo/model/60_158+39_v2/best_model.pth'
	scaler_path = 'E:/stock/baseline_repo/model/60_158+39_v2/scaler.pkl'
	
	output_path = 'E:/stock/baseline_repo/output/result_v2.csv'
